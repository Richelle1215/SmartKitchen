                        ...
                        <div class="p-4 bg-gray-50 rounded-lg">
                            <div class="grid grid-cols-2 gap-2">
                                ...
                                <div class="text-right">
                                    <input type="number" placeholder="Price" name="ingredient_prices[${ing.id}]" 
...
document.getElementById('calculateBtn').addEventListener('click', function() {
    ...
    .then(data => {
        ...
        document.getElementById('costPerServing').textContent = '$' + data.cost_per_serving.toFixed(2);
        document.getElementById('resultServings').textContent = data.servings;
        ...
        data.ingredients.forEach(ing => {
            breakdown += `
                <div class="flex justify-between py-1 border-b border-gray-200">
                    ...
                    <span class="font-semibold">$${ing.total.toFixed(2)}</span>
                </div>
            `;
        });
